...
var _sorting = __webpack_require__(53);
...
var ProductListing = function (_React$Component) {
    ...
    _createClass(ProductListing, [{
        ...
        value: function searchHandler(searchKey) {
            this.props.dispatch(_plpActions2.default.searchProducts(searchKey));
        }
    }, {
        key: 'filterHandler',
...
var _productCard = __webpack_require__(47);
...
if(false) {
	module.hot.accept("!!../../node_modules/css-loader/index.js??ref--1-1!./product-card.css", function() {
		var newContent = require("!!../../node_modules/css-loader/index.js??ref--1-1!./product-card.css");
...
// module
exports.push([module.i, ".satyam_product-card__card--2KKI0{\r\n    background-color: aqua;\r\n    padding: 10px;\r\n    margin: 10px;\r\n    display: inline-block;\r\n    vertical-align: top;\r\n    min-width: 200px;\r\n    min-height: 100px;\r\n}", ""]);

// exports
exports.locals = {
	"card": "satyam_product-card__card--2KKI0"
};
...
var searchAction = function searchAction(data) {
    return {
...
var PLPActions = {
    ...
    searchProducts: function searchProducts(key) {
        return function (dispatch) {
            var searchData = [].concat(_toConsumableArray(cacheData.products));
            if (key !== "") {
